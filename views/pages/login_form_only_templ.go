...
func LoginFormOnly(errorMessage string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"max-w-md mx-auto bg-white rounded-lg shadow-md p-8\" id=\"login-container\"><h2 class=\"text-2xl font-bold text-center mb-6\">Login</h2>")
		if templ_7745c5c3_Err != nil {
		...
		if errorMessage != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/pages/login_form_only.templ`, Line: 9, Col: 18}
			}
